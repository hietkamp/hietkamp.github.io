...
**Het model/de structuur van de Essence Kernel/taal** (`essence/essence-kernel.rdf`, `essence/essence-language.owl` — welke alpha's, states, activity spaces en competenties er zijn) implementeert de OMG-specificatie *Essence – Kernel and Language for Engineering Methods* (ptc/25-05-01) en valt onder OMG's eigen specification license, niet onder GPLv3. De namen en omschrijvingsteksten in die bestanden zijn wél eigen werk — in eigen Nederlandse bewoordingen geschreven, geen vertaling van OMG's Engelse brontekst — en vallen daarmee onder GPLv3. De Essence Architecture Method in dit project is onze eigen implementatie bovenop die Kernel — niet de OMG-standaard zelf. Zie [`NOTICE.md`](NOTICE.md) voor het volledige onderscheid en de officiële specificatiebron.
